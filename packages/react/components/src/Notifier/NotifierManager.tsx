import React, { useState, useImperativeHandle, Key, useMemo, RefObject, Fragment } from 'react';
...
function NotifierManager<N extends NotifierData>(props: NotifierManagerProps<N>) {
  ...
  const notifiersShouldRendered =
    typeof maxCount === 'number' && notifiers.length > maxCount ? notifiers.slice(0, maxCount) : notifiers;
