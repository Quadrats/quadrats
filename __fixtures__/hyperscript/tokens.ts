...
import { Node, Path, Text } from '@quadrats/core';
...
export const getAnchorOffset = (text: Text): [number, AnchorToken] | undefined => ANCHOR.get(text);
...
export const getFocusOffset = (text: Text): [number, FocusToken] | undefined => FOCUS.get(text);
